...
{
  "$end", "error", "$undefined", "NUMBER", "SALARIO_BASE",
  "HORAS_TRABAJADAS", "TASA_IMPUESTOS", "DEDUCCIONES", "CALCULAR", "PLUS",
  "MINUS", "MULTIPLY", "DIVIDE", "EOL", "$accept", "input", "line",
  "setting", 0
};
#endif
...
{
       2,    10,    11,    14,     3,     4,     5,     6,     7,    12,
      13,     0,     0,     0,    15
};

static const yytype_int8 yycheck[] =
{
       0,     3,     3,    13,     4,     5,     6,     7,     8,     3,
       3,    -1,    -1,    -1,    13
};
...
/* Line 1455 of yacc.c  */
#line 38 "parser.y"
    { horas_trabajadas = (yyvsp[(2) - (2)].fval); ;}
    break;
